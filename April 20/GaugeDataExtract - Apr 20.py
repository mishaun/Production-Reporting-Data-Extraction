...
gauge_sheet_directory = abspath + '/Gauge Sheets - Apr 2020'
...
data_map_path = 'April 2020 - MPLP - PR EDI.xlsm'
data_map = pd.read_excel(data_map_path, header = 4, sheet_name = "Working Spreadsheet Apr 20", usecols = 'C:AQ')
