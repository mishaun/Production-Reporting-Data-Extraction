...
gauge_sheet_directory = abspath + '/Gauge Sheets - Jun 2020'
...
data_map_path = 'Jun 2020 - MPLP - PR EDI.xlsm'
data_map = pd.read_excel(data_map_path, header = 4, sheet_name = "Working Spreadsheet Jun 20", usecols = 'C:AQ')
