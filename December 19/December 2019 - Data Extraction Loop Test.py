...
data_map_path = 'Full PR and Data Map.xlsm'
data_map = pd.read_excel(data_map_path, header = 4, sheet_name = "Working Spreadsheet November 19", usecols = 'C:AQ')
...
checker = map_filtered[["Lease Name","Well Number", "Gauge Sheet Prod Vol","Manual Extraction Gauge Sheet Prod", "Closing Oil Stock","Manual Extraction Closing Stock","Gauge Prod Diff", "Closing Stock Diff"]]
